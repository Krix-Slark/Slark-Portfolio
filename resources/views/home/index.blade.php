...
@section('content')
  ...
  <div class="blob-container">
    ...
    <div class="blob blue bottom-left"></div>
    <div class="blob green bottom-right"></div>
  </div>
  <!-- Navbar -->
  <nav id="mainNavbar" class="navbar navbar-expand-lg navbar-dark fixed-top border-0 navbar-custom"
  ...
  <section id="featured-projects" style="position: relative; z-index: 0;">
    ...
    <div class="container mt-5">
      <div class="row justify-content-center align-items-start">
        ...
        <div class="col-12 col-md-5 mb-4 project-card" data-category="landing">
          <div class="card border border-dark h-100">
            <div class="card-body bg-black text-white">
              <div id="carousel1" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner rounded">
                  <div class="carousel-item active">
                    <img src="images/fitchallenge-home.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="images/fitchallenge-dashboard.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="images/fitchallenge-workout-plan.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="images/fitchallenge-workout-detail.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="images/fitchallenge-nutrition.png" class="d-block w-100" alt="...">
                  </div>
                </div>
              ...
              <h2 class="mt-4">FitChallenge Website</h2>
              <span class="badge bg-dark text-white py-3 mt-3 px-3" style="border:2px solid #a020f0;">Landing Page</span>
              <p class="text-white-50 mt-3 fs-5">A responsive fitness website offering a personalized workout plan and 
                custom nutrition plan tailored for a specific client.</p>
            </div>
          </div>
        </div>
        ...
        <!-- Card 4 -->
        <div class="col-12 col-md-5 mb-4 project-card" data-category="fullstack">
          <div class="card border border-dark h-100">
            <div class="card-body bg-black text-white">
              <div id="carousel4" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner rounded">
                  <div class="carousel-item active">
                    <img src="images/ygea-landing.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="images/ygea-gold-calculator.png" class="d-b`lock w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="images/ygea-about.png" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="images/ygea-news.png" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="images/ygea-member.png" class="d-block w-100" alt="...">
                    </div>
                </div>
              ...
              <h2 class="mt-4">YGEA Website</h2>
              <span class="badge bg-dark text-white py-3 mt-3 px-3" style="border:2px solid #a020f0;">Fullstack Website</span>
              <p class="text-white-50 mt-3 fs-5">A modern site for the Yangon Gold Entrepreneurs Association: industry news, 
                member directory, events, and resources.
  ...
  <div class="about-container d-flex flex-column justify-content-center align-items-center mt-5">
    <h1 class="title fw-bold" style="color: #00ffffff; font-size: 3.5rem;">About Me</h1>
  ...
  <div class="container-fluid mt-5">
    <div class="row justify-content-start align-items-start">
      <div class="col-12 col-md-6">
        ...
        <div class="row mt-4">
          <div class="col-12 col-md-6 ">
            <div class="card bg-black border-light mt-3 py-0">
              <div class="card-body text-start">
                <div class="card-title text-info">
                  <i class="fas fa-award fs-3"></i>
                </div>
                <p class="text-white fs-5 mt-2">Newbie Developer</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="card bg-black border-light mt-3">
              <div class="card-body text-start">
                <div class="card-title text-info">
                  <i class="fas fa-book-open fs-3"></i>
                </div>
                <p class="text-white fs-5 mt-2">Always learning</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="card bg-black border-light mt-3">
              <div class="card-body text-start">
                ...
                <p class="text-white fs-5 mt-2">Collaborative</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="card bg-black border-light mt-3">
              <div class="card-body text-start">
                ...
                <p class="text-white fs-5 mt-2">Problem Solver</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-12 col-md-6">
          ...
          <div class="card-body text-start text-white">
            ...
            <div class="progress mb-3" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 85%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff);  border-radius: 10px;"></div>
            </div>

            <!-- Bootstrap -->
            <p><i class="fab fa-bootstrap me-3" style="color: #7952b3;"></i> Bootstrap <span class="float-end">80%</span>
            </p>
            <div class="progress mb-3" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 80%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff); border-radius: 10px;"></div>
            </div>
            ...
            <div class="progress mb-3" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 75%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff); border-radius: 10px;"></div>
            </div>
        ...
        <div class="card bg-black border-light mb-4">
          <div class="card-body text-start text-white">
            <h2 class="card-title text-white mt-3 mb-4 fs-3" style="background: linear-gradient(90deg, #aa54ffff, #0066ffff); -webkit-background-clip: text; 
                      -webkit-text-fill-color: transparent; background-clip: text; color: transparent; ">Currently
              Learning
            </h2>
            <!-- Laravel -->
            ...
            <div class="progress mb-3" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 40%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff);  border-radius: 10px;"></div>
            </div>
            ...
            <div class="progress mb-3" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 30%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff); border-radius: 10px;"></div>
            </div>
            ...
            <!-- UI/UX Design-->
            <p><i class="fab fa-figma  me-3" style="color:purple;"></i> UI/UX Design <span class="float-end">25%</span>
            </p>
            <div class="progress" style="height: 8px;">
              <div class="progress-bar" role="progressbar"
                style="width: 25%; background: linear-gradient(90deg, #aa54ffff, #00e1ffff); border-radius: 10px;"></div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-12">
                <form action="#" method="POST" class="row g-3">
                  <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="name" name="name" class="form-control bg-black border-black"
                      placeholder="Your name" required>
                  </div>
                  <div class="col-12 col-md-6">
                    <label for="email" class="form-label text-white">Email</label>
                    <input type="email" id="email" name="email" class="form-control bg-black border-black"
                      placeholder="your.email@example.com" required>
                  </div>
                  <div class="col-12">
                    <label for="subject" class="form-label text-white">Subject</label>
                    <input type="text" id="subject" name="subject" class="form-control bg-black border-black"
                      placeholder="Project inquiry , collaboration , etc..." required>
                  </div>
                  <div class="col-12">
                    <label for="message" class="form-label text-white">Message</label>
                    <textarea id="message" name="message" class="form-control bg-black border-black" rows="4"
                      placeholder="Tell me about your project..." required></textarea>
                  </div>
                  <div class="col-12">
                    <button type="submit" class="btn px-4 mt-2 text-dark-50"
                      style="background: linear-gradient(90deg, #bc7efaff, #7db0fcff);"><i
                        class="fas fa-paper-plane me-2 text-dark-50"></i> Send Message</button>
                  </div>
                </form>
              </div>
            </div>
